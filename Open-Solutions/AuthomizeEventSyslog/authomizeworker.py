...
"""
# GLOBAL VARIABLES
API endpoints for Authomize (see documentation)
URL = 'https://api.authomize.com/v1/incidents/search'
URL2 = 'https://api.authomize.com/is_alive'
Authomize Token from platfomr
token = 'atmzNzkwMDYyMTU0MTg6WUFEV0ZfMkNMRk1XWTRLVTRHNEVZWEczQkZTTk9fU0VQTVJSQUFOWFZBRw=='
# Update the customer ID to your Log Analytics workspace ID
customer_id = 
# For the shared key, use either the primary or the secondary Connected Sources client authentication key   
shared_key = 
# The log type is the name of the event that is being submitted - This should NOT be changed
log_type =
# Name of file that will be used for static storage of datetime in UTC
