# OpenITDR Workflow Usage (_Release - 1.0_)
...
Now watch the [video](https://app.box.com/s/m8qd7m8brimgeax4tsjg71ubyrzls6ns) showing how to switch on and update the other nodes within this flow. You may need to *download* before you can watch.
